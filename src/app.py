...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice and aquatic fitness for all levels",
    ...
    "Debate Team": {
        "description": "Build public speaking and argumentation skills for competitions",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "mia@mergington.edu"]
    },
    "Science Club": {
        "description": "Investigate scientific concepts through experiments and projects",
